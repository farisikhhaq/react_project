...
const Footer = () => {
    ...
    const footerLink = [
        ...
        { id: 3, text: '26 Indonesia' },
        { id: 4, text: 'Jl.Soekarno Hatta' },
        { id: 5, text: 'Tourism Help Line' },
        { id: 6, text: 'Prescribing Tools' },
        { id: 7, text: 'Specialty Merchandise Guarantted' },
        { id: 8, text: 'Claims Guaranteed' },
        { id: 9, text: '+ (62)896-5374-5172' },
        ...
        <footer className="text-gray-600 poppins bg-gray-100">
            <div className="max-w-screen-xl px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
                ...
                <div className="flex-grow flex justify-end flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
                        ...
                        <nav className="list-none mb-10 flex flex-col space-y-2">
                            {/* list  */}
                            {
                                footerLink.slice(0, 4).map(item => (
                                    <a href="https://github.com/farisikhhaq/react_project/tree/master/TourismUAS" target="_blank" rel="noopener noreferrer" key={item.id} className="text-sm hover:underline">{item.text}</a>
                                ))
                            }
                        </nav>
                    </div>
                    ...
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        <h2 className="poppins text-gray-900 text-base mb-3 font-semibold">Kontak</h2>
                        <nav className="list-none mb-10 flex flex-col space-y-2">
                            {/* list  */}
                            {
            ...
            <div className="bg-blue-700">
                <div className="max-w-screen-xl mx-auto py-4 px-5 flex flex-wrap flex-col justify-center sm:flex-row">
                    <p className="text-white text-sm text-center sm:text-left">© 2022 Developed by —
                        <a href="https://github.com/farisikhhaq" rel="noopener noreferrer" className="text-white ml-1" target="_blank">Faris Irfan Hisyam</a>
                    </p>
                </div>
            </div>
        </footer>
